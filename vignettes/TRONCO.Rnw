...
\author[1,3]{Luca De Sano}
\author[1,4]{Alex Graudenzi}
\author[1]{Giancarlo Mauri}
\author[5]{Bud Mishra}
\author[6]{Daniele Ramazzotti}
...
\affil[3]{Institute of Biomembranes and Bioenergetics of the Italian National Research Council (IBBE-CNR), Bari, Italy}
\affil[4]{Institute of Molecular Bioimaging and Physiology of the Italian National Research Council (IBFM-CNR), Milano, Italy}
\affil[5]{Courant Institute of Mathematical Sciences, New York University, New York, USA.}
\affil[6]{Department of Pathology, Stanford University, Stanford, CA, USA.}
