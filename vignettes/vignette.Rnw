...
Milano, Italy.} \and
Giulio Caravagna\footnote{School of Informatics, Edinburgh University, Edinburgh, UK.} \and
Luca De Sano$^\ast$ \footnote{Institute of Biomembranes and Bioenergetics of the Italian National Research Council (IBBE-CNR), Bari, Italy}\and
Alex Graudenzi$^\ast$ \footnote{Institute of Molecular Bioimaging and Physiology of the Italian National Research Council (IBFM-CNR), Milano, Italy}\and
...
Daniele Ramazzotti\footnote{Department of Pathology, Stanford University, Stanford, CA, USA.} 
}
...
\begin{tabular}{ll}
{\bf Version.}& {2.5.5} (October 2016) \\
{\bf Codename.} & Coconut crub \\
...
\begin{itemize}
\item[2.5.5] Current stable version.
\item[2.5.3] Latest development version. New algorithms: Edmonds, Gabow, Chow-Liu and Prim. New scores: PMI, CPMI, MI. 
\item[2.4.3] Current stable version. Bugfix
...
Edmond & Directed Minimum Spanning Tree with Mutual Information & Ind & \href{https://sites.google.com/site/troncopackage/}{In preparation.}\\ \hline
Gabow & Partially Directed Minimum Spanning Tree with Mutual Information & Ind & \href{https://sites.google.com/site/troncopackage/}{In preparation.}\\ \hline
Chow Liu & Undirected Minimum Spanning Tree with Likelihood-Fit & Ind & \href{https://sites.google.com/site/troncopackage/}{In preparation.}\\ \hline
Prim & Undirected Minimum Spanning Tree with Mutual Information & Ind & \href{https://sites.google.com/site/troncopackage/}{In preparation.}\\ \hline
 \end{tabular}
\end{center}
