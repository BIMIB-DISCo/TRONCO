...
par(mfrow = c(2,2))
tronco.plot(model.caprese, fontsize = 25, scale.nodes = 0.6, legend = FALSE)
tronco.plot(model.edmonds, fontsize = 25, scale.nodes = 0.6, legend = FALSE)
tronco.plot(model.chowliu, fontsize = 25, scale.nodes = 0.6, legend.cex = .7)
tronco.plot(model.prim, fontsize = 25, scale.nodes = 0.6, legend = FALSE)
@
\end{mybox}
