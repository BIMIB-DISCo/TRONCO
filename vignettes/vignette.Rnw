...
<<import.MAF.crc_maf, results='hide'>>=
dataset_maf = import.MAF(crc_maf, 
...
<<oncocl, fig.show='hide', fig.width=5, fig.height=5>>=
oncoprint(aCML, 
    legend = FALSE, 
...
<<onco-stages, fig.show='hide', fig.width=6, fig.height=5>>=
...
<<onco-clus2, fig.show='hide', fig.width=6, fig.height=5>>=
...
<<onco-pathway, fig.show='hide', fig.width=6.5, fig.height=2>>=
...
<<onco-pathway-viz, fig.show='hide', fig.width=6.5, fig.height=1.8, results='hide'>>=
...
<<onco-kras-nras, fig.show='hide', fig.width=6, fig.height=1>>=
...
<<capri-plot,fig.show='hide',fig.width=4,fig.height=4>>=
...
<<mst-plot,fig.show='hide',results='hide',fig.width=7,fig.height=7>>=
par(mfrow = c(2,2))
...
<<figplotboot,fig.show='hide',fig.width=4,fig.height=4>>=
...
<<plot-conf,fig.show='hide',fig.width=4,fig.height=4>>=
tronco.plot(model.boot, 
    fontsize = 12, 
    scale.nodes = .6, 
